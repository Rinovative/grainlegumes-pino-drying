...
from . import generation_config as config_schema
...
IdMembership: TypeAlias = config_schema.IdMembership
EvaluationRegime: TypeAlias = config_schema.EvaluationRegime
