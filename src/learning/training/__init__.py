...
Provides:
- adapter: task-owned batch adaptation and matched-compute protocol contracts
...
if TYPE_CHECKING:
    from . import learning_training_adapter as adapter
...
_MODULES = {
    "adapter": "learning_training_adapter",
...
__all__ = ["adapter", "checkpoint", "events", "loop", "optim"]
